...
const Footer = () => {
  return (
    <div>
      <footer className=" py-2  bg-[#333333] text-white ">
        <div className="grid justify-center gap-5 lg:gap-0 items-center lg:grid-cols-4 py-5">
          <div className="  px-6 ">
            <img src="logo_footer.png" alt="footer_logo" />
            <p>
              Travel Monk Adventures is a professional, well-managed young team
              offering expert trekking, adventure activities, holiday tours, and
              road trips in the scenic hills of Himachal Pradesh, Uttarakhand,
              Leh-Ladakh, and North East India, as well as customized tours
              across India.
            </p>
          </div>
          <div className=" flex-col gap-2 flex lg:justify-start   items-baseline    justify-center  px-6">
