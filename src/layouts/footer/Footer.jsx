      ...
      <footer className=" py-2  bg-[#333333] text-white ">
        <div className="grid justify-center gap-5 lg:gap-0 items-center lg:grid-cols-4 py-5" >
          ...
          <div className="flex mx-2 flex-col gap-4 px-4 lg:py-x-4">
            ...
            <p className="text-center">Follow us on social media platforms and stay updated </p>
          </div>
          ...
          <div className="flex  flex-col justify-center items-center lg:items-start lg:justify-start  gap-4   ">
            ...
            <div class="mb-5">
              ...
              <button type="submit" className="text-white  lg:w-1/2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm   px-5 py-2.5 text-center ">Submit</button>
              </div>
