    ...
    const busData = [
        {
            ...
            duration: "3h 45m",
            destinationArrivalTime: "11:45 AM",
            destinationLocation: "Berlin",
            leavingPlace: "Munich",
            price: 25.99,
            rating:3.9,
            type: "Electric AC Seater (2+2)",
            seat: 2,
        },
        {
            busCompany: "Neugobus",
        ...
        },
        {
            ...
            duration: "4h 10m",
            destinationArrivalTime: "05:10 PM",
            destinationLocation: "Hamburg",
            leavingPlace: "Düsseldorf",
            price: 32.75,
        },
        {
            busCompany: "Neugobus",
            ...
            duration: "5h 20m",
            destinationArrivalTime: "10:20 PM",
            destinationLocation: "Munich",
            leavingPlace: "Stuttgart",
            price: 29.99,
        },
        {
            busCompany: "FlixBus",
            ...
            duration: "3h 15m",
            destinationArrivalTime: "09:45 AM",
            destinationLocation: "Nuremberg",
            leavingPlace: "Augsburg",
            price: 22.00,
        },
        ...
        <div className=" p-10 bg-gray-200">
            ...
            <div className="flex flex-row w-full">
                ...
                <div className="w-[75%] mt-2">
                  {busData.map((bus)=>(<>
                   <div className="bg-white w-full rounded-xl mt-6 pl-8 pr-8 pt-6 pb-4">
                     <div className="flex flex-row justify-between">
                        <div className="flex flex-col">
                                  <div className="flex flex-row items-center">
                                  <p className="pr-3 font-bold text-xl">{bus.busCompany}</p>
                                      <span className="pr-1"><FaStar /> </span> 
                                  <p className=" font-bold text-xl"> {bus.rating}</p>
                                  </div>
                           
                          <div className="flex flex-row">
                                <p className="text-slate-500 font-normal">{bus.type}</p>
                         ...
                         <div className="flex flex-col">
                                  <div className="flex flex-row">
                                    ...
                                    <p className="text-2xl font-semibold">{bus.startingTime} <span className="text-slate-500 font-light"> ---- </span> </p>
                                    <p className="pr-9">{bus.leavingPlace}</p>
                                    </div>
                                     
                                    <p className="pt-1 pr-1 pl-1">{bus.duration}</p>
                                     <div className="flex flex-col items-center">
                                          <p className="text-2xl font-semibold"> <span className="text-slate-500 font-light"> ---- </span> {bus.destinationArrivalTime}</p>
                                        <p className="pl-9">{bus.destinationLocation}</p>
                                     </div>
                            ...
                            <div className="flex- flex-col">
                                  <p className="text-slate-500 font-normal">Starting From</p>
                              <p className="font-bold text-2xl">{bus.price}</p>
                            </div>
 
                     </div>
                     <div className=" p-1 mt-2 text-center text-base text-slate-500 font-normal"><p>Amenities | Bus Photos | Booking & Dropping Points | Booking Policies | Seats</p></div>
                   </div>
                  </>))}                    
                </div>
            </div>
