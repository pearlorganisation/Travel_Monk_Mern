...
const Cruize = () => {
  ...
  const sortByOptions = [
    ...
    {
      id: 2,
      shipname: "Price - Low to High",
    },
    {
      id: 3,
      shipname: "Price - High to Low",
    },
    {
      id: 4,
      shipname: "High Ratings",
    },
    {
      id: 5,
      shipname: "High Reviews",
    },
    {
      id: 6,
      shipname: "Popular",
  ...
  const cruiseData = [
    {
      ...
      top: "Only One Seat Left",
      title: "Western Caribbean and Perfect Day",
      shipname: "Star of the Seas",
      visiting:
        "Orlando (Port Cavanni), Florida Perfect Day at CocoCay, Bahamas (Cozumuzhal)",
      price: "17000",
      taxes: "3000",
      rating: "5",
    },
    {
      id: 2,
      image:
        "https://www.shutterstock.com/image-photo/concept-vacation-travel-generic-cruise-600nw-2450801853.jpg",
      title: "Eastern Caribbean and Naribo Max",
      shipname: "Star of Crusaders",
      visiting:
        "Orlando (Port Cavanni), Florida Perfect Day at CocoCay, Bahamas (Cozumuzhal)",
      price: "15000",
      originalPrice: "20000",
            ...
            <div className=" bg-white w-full rounded-xl mt-6">
              <div className="flex flex-col  items-center rounded-xl border  text-center  md:flex-row md:items-start md:text-left relative">
                ...
                <div className="mb-0  mr-0 md:mr-6 md:mb-0 ">
                  ...
                  {cruize.top && (
                    <div className="absolute top-2 left-3 bg-red-500 p-2 rounded-xl">
                      <h3 className="text-gray-200 text-sm ">{cruize.top}</h3>
                    </div>
                  )}
                </div>
                <div className="px-4 py-4">
                  ...
                  <p className="mb-4 mt-4 text-sm font-medium text-blue-500">
                    View ports and maps
                  </p>
                  ...
                  <div className="flex flex-row gap-4 justify-start items-center">
                    ...
                    {cruize.tag && (
                      <div className="bg-yellow-500 rounded-lg p-2 mt-6">
                        <h3 className=" text-sm "> {cruize.tag}</h3>
                      </div>
                    )}
                  </div>

                  <h3 className="text-gray-400 text-lg mt-4">
                    + ₹ {cruize.taxes} taxes and fees per night
                  </h3>
                </div>
              </div>
            </div>
