            ...
            <ul className="space-y-3 text-gray-600">
              <li>
                <div className="flex items-center">
                  ...
                  <span className="ml-2">
                    If cancellations are made 15 days before the start date of
                    the trip, 20% of total tour cost will be charged as
                    cancellation fees.
                  </span>
                </div>
              </li>
              <li>
                <div className="flex items-center">
                  ...
                  <span className="ml-2">
                    If cancellations are made within 7-15 days before the start
                    date of the trip, 30% of total tour cost will be charged as
                    cancellation fees.
                  </span>
                </div>
              </li>
              <li>
                <div className="flex items-center">
                  ...
                  <span className="ml-2">
                    If cancellations are made within 0-7 days before the start
                    date of the trip, 50% of total tour cost will be charged as
                    cancellation fees.
                  </span>
                </div>
              </li>
              <li>
                <div className="flex items-center">
                  ...
                  <span className="ml-2">
                    {" "}
                    Cancellations are strictly subjected to cancellation
                    policies mentioned on the website & are irrespective of the
                    date of booking.
                  </span>
                </div>
              </li>
              <li>
                <div className="flex items-center">
                  ...
                  <span className="ml-2">
                    ...
                    restrictions, certain trips or activities may get cancelled.
                    In such cases operator will try their best to provide an
                    alternate feasible. However a cash refund will not be
